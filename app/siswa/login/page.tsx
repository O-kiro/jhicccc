...
export const metadata: Metadata = {
  ...
  description:
    "Masuk ke portal siswa MAN Kota Batu — CBT, E-Learning, RDM, dan Perpustakaan Digital.",
      ...
      <div className="grid min-h-screen grid-cols-1 lg:grid-cols-2">
          ...
          <div className="relative mx-auto flex h-full max-w-xl flex-col justify-between">
            <div>
              ...
              <p className="mt-5 max-w-md text-sm leading-relaxed text-white/75">
                Gerbang digital menuju ekosistem pendidikan yang memadukan tradisi keilmuan Islam dan
        ...
        <div className="flex flex-col justify-center px-5 py-12 sm:px-8 lg:px-12">
          <div className="mx-auto flex w-full max-w-md flex-col">
            ...
            <Link
              href="/"
              className="mx-auto mt-8 inline-flex items-center gap-1.5 text-xs font-semibold text-muted transition-colors hover:text-ink"
            >
