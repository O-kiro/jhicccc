...
import { nextClass, portalNav, student } from "@/lib/siswa";
...
function NextClassCard() {
  return (
    <div className="bg-teal-gradient relative overflow-hidden rounded-card p-4 text-on-dark">
      ...
      <button
        type="button"
        className="btn-sheen mt-3.5 inline-flex w-full items-center justify-center gap-1.5 rounded-full bg-white/15 px-4 py-2 text-xs font-semibold text-on-dark transition-colors hover:bg-white/25"
      >
      ...
      <div className="mt-auto space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          <Link
            href="/kontak"
            onClick={onNavigate}
            className="inline-flex items-center justify-center gap-1.5 rounded-full border border-line px-3 py-2 text-xs font-semibold text-muted transition-colors hover:border-ink/25 hover:text-ink"
          >
          ...
          <Link
            href="/siswa/login"
            onClick={onNavigate}
            className="inline-flex items-center justify-center gap-1.5 rounded-full border border-line px-3 py-2 text-xs font-semibold text-muted transition-colors hover:border-gold/40 hover:text-gold-strong"
          >
        ...
        <header className="sticky top-0 z-30 border-b border-line bg-canvas/85 backdrop-blur-md">
          <div className="flex h-16 items-center gap-3 px-5 sm:px-8">
            <button
              ...
              className="grid h-10 w-10 place-items-center rounded-full border border-line text-ink transition-colors hover:bg-surface-2 lg:hidden"
            >
            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              <button
                ...
                className="relative grid h-10 w-10 place-items-center rounded-full border border-line text-ink transition-colors hover:bg-surface-2"
              >
