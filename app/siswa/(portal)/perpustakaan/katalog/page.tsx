...
export default async function KatalogPage({
  ...
  const tautanKategori = (k: string) => {
    ...
    const s = p.toString();
    return `/siswa/perpustakaan/katalog${s ? `?${s}` : ""}`;
  };
  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      <PageHead
        ...
        title="Katalog Buku"
        desc={`Kamu sedang meminjam ${katalog.active_loans} dari ${katalog.loan_quota} buku yang diizinkan.`}
      />

      {/* GET biasa: tetap jalan tanpa JavaScript, dan hasilnya bisa dibagikan. */}
      <form action="/siswa/perpustakaan/katalog" className="flex flex-wrap gap-3">
